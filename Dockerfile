...
RUN find /usr/share/nginx/html -type f -name '*.html' -exec sed -i \
  ...
  -e 's#reklamy.js"#reklamy.js?v=20260725-zonky-fix-2"#g' \
  -e 's#</body>#<script src="/navigation.js?v=20260725-inzerce-footer-2" defer></script><script src="/upoutavky.js?v=20260724-nemocnice-cyber-1" defer></script><script src="/reklamy-oprava-obrazku.js?v=20260725-zonky-fix-3" defer></script></body>#g' {} +
