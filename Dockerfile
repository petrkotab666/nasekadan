...
# Načíst responzivní mobilní styl na všech HTML stránkách a obejít starou cache prohlížeče.
RUN find /usr/share/nginx/html -type f -name '*.html' -exec sed -i \
  's#</head>#<link rel="stylesheet" href="/mobile.css?v=20260724-1"></head>#g' {} +
