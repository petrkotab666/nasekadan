...
<article class="article">
  ...
  <h2>Co čeká řidiče na cestě mezi Žatcem a Kadaní</h2>
  ...
  <div class="source-list">
    ...
    <ul>
      <li><a href="{CITY_SOURCE}" target="_blank" rel="noopener noreferrer">Město Žatec – oznámení úplné uzavírky silnice II/225 od 4. do 11. srpna</a></li>
