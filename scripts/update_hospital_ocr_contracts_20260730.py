...
for old in ('2026-07-30T12:15:00+02:00', '2026-07-30T13:15:00+02:00'):
    text = text.replace(old, '2026-07-30T13:24:00+02:00')
for old in ('Aktuální zpráva · aktualizováno v 12:15', 'Aktuální zpráva · aktualizováno v 13:15'):
    text = text.replace(old, 'Aktuální zpráva · aktualizováno v 13:24')
for old in ('k 30. červenci v 12:15 nebyl', 'k 30. červenci v 13:15 nebyl'):
    text = text.replace(old, 'k 30. červenci v 13:24 nebyl')
for old in ('Poslední ověřená aktualizace 30. července 2026 v 12:15.', 'Poslední ověřená aktualizace 30. července 2026 v 13:15.'):
...
if box_1215 in text:
    ...
    text = text.replace(box_1315, new_box)
