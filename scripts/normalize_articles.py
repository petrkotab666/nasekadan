...
def normalize_article(text: str) -> str:
    ...
    # Jediný společný balík skriptů na konci stránky.
...
def validate(path: Path, text: str) -> list[str]:
    ...
    for asset in ("/reklamy.js", "/reklamy-oprava-obrazku.js", "/obsah-doplnky.js"):
