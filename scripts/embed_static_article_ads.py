...
# Tři opakování čtyř partnerů vyplní i dlouhé články bez obřích prázdných mezer.
REPEATED_ADS = ADS * 3

BLOCK = '<div class="static-article-ads" data-static-article-ads="locked-v2" aria-label="Reklamy v pravém sloupci článku">' + ''.join(
    ...
    for url,img,alt in REPEATED_ADS
) + '</div>'
