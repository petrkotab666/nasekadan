...
<h2>Krvetvorné buňky jí odebrali pomocí separátoru</h2>
<p>V jejím případě nebylo potřeba odebírat kostní dřeň z pánevní kosti. Několik dní před odběrem si aplikovala přípravné injekce, které pomohly vyplavit krvetvorné buňky do krevního oběhu. Při samotném odběru proudila krev přes separátor, který potřebné buňky oddělil, zatímco ostatní složky krve se vracely zpět do těla. Celý výkon trval přibližně čtyři hodiny a probíhal pod dohledem zdravotníků.</p>
