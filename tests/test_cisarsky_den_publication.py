...
teaser = re.search(r'<section class="game-cta">.*?</section>', script, re.S)
assert teaser, 'Publikační skript neobsahuje očekávaný teaser hry.'
assert 'href="/hry/prijezd-karla-iv/"' not in teaser.group(0)

# Samotný generátor musí výslovně odmítnout neověřený vstup zdarma i předčasný odkaz hry.
assert "'vstup zdarma'" in script
assert "'href=\"/hry/prijezd-karla-iv/\"'" in script
