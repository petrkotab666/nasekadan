...
function isDirectDetail(e){return /\/dre-cs\/|\/detail|\/akce\//i.test(String(e.source||''))}
function eventCard(e,now){
 ...
 const linkText=isDirectDetail(e)?'Otevřít detail akce →':'Otevřít kalendář pořadatele →';
